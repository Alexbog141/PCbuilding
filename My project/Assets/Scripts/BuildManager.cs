    ...
    public void OnPartInstalled(PcPart installedPart)
    {
        switch (installedPart.type)
        {
            case PartType.CPU:
                ...
                {
                    if (db.cpu[i].id == installedPart.id) { installedPart.LogConnection(db.cpu[i].name); break; }
                }
                break;
            ...
            case PartType.GPU:
                ...
                {
                    if (db.gpu[i].id == installedPart.id) { installedPart.LogConnection(db.gpu[i].name); break; }
                }
                break;
            ...
            case PartType.Motherboard:
                ...
                {
                    if (db.motherboard[i].id == installedPart.id) { installedPart.LogConnection(db.motherboard[i].name); break; }
                }
                break;
            ...
            case PartType.RAM:
                ...
                {
                    if (db.ram[i].id == installedPart.id) { installedPart.LogConnection(db.ram[i].name); break; }
                }
                break;
            ...
            case PartType.PSU:
                ...
                {
                    if (db.psu[i].id == installedPart.id) { installedPart.LogConnection(db.psu[i].name); break; }
                }
                break;
            ...
            case PartType.Cooler:
                ...
                {
                    if (db.cooler[i].id == installedPart.id) { installedPart.LogConnection(db.cooler[i].name); break; }
                }
                break;
            ...
            case PartType.Storage:
                ...
                {
                    if (db.storage[i].id == installedPart.id) { installedPart.LogConnection(db.storage[i].name); break; }
                }
                break;
            ...
            case PartType.Case:
                ...
                {
                    if (db.cases[i].id == installedPart.id) { installedPart.LogConnection(db.cases[i].name); break; }
                }
                break;
        }
    }
